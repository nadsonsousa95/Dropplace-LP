  ...
  return (
    <>
      ...
      <section id="contato" className="bg-white text-[#0349ad] py-20 flex flex-col items-center px-5 text-center">
        ...
        <a href="https://w.app/dropplace-startup" className="bg-[#ef7d00] shadow-lg text-white font-poppins font-bold py-4 px-8 rounded-md inline-block mt-8 transition-all transform hover:scale-105 active:scale-105 hover:bg-[#914b00] active:bg-[#914b00] focus:bg-[#914b00]">Fale com um especialista</a>
      </section>
