  ...
  return (
    <>
      <section className="bg-gradient-to-t from-[#004AAD] to-[#00357a] relative text-white py-20 px-5 text-center overflow-hidden min-h-screen flex flex-col justify-center">
        ...
        <header className="relative z-10 flex flex-col items-center justify-center mb-10">
          ...
          <div className="relative z- mx-auto mt-10">
            ...
            <a href="#solucoes" className="bg-[#ef7d00] text-white text-center font-bold py-4 px-8 text-lg rounded-md my-10 flex flex-row items-center gap-2 justify-center transform hover:scale-105 w-50 mx-auto hover:bg-[#914b00] active:bg-[#914b00] focus:bg-[#914b00] cursor-pointer transition-all duration-300">
      ...
      <section id="solucoes" className="bg-[#0349ad] text-white py-20 px-5 text-center flex flex-col items-center">
        ...
        <a href="#contato" className="bg-white text-[#0349ad] font-poppins font-bold py-4 px-8 rounded-md inline-block mt-8 transition-transform transform hover:scale-105 active:bg-gray-200 focus:bg-gray-200">Fale com um especialista</a>
      </section>
